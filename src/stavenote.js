...
const highlightPlayerNoteStyle = {
    shadowBlur: 0,
    shadowColor: '#94ceef',
    fillStyle: '#94ceef',
    strokeStyle: '#94ceef',
...
export class StaveNote extends StemmableNote {
  ...
  // }
    ...
    drawFlag() {
        ...
        if (glyph.flag && render_flag) {
            ...
            // Draw the Flag
            Vex.Flow.Glyph.renderGlyph(
          ctx, flag_x, flag_y, this.render_options.glyph_font_scale, flag_code);
  ...
  // Render the stem onto the canvas
    ...
    setHighlight(highlight, keyIndex) {
        if (highlight === 'player') {
    ...
    clone(newProps) {
        ...
        const mergedProps = Object.assign({}, currentProps, newProps);
